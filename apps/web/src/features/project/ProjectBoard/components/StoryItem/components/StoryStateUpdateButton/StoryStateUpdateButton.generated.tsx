...
export type StoryStateUpdateButton_StoryFragment = { __typename?: 'Story', id: string, state: Types.StoryState };

export type StoryStateUpdateButton_UpdateStoryStateMutationVariables = Types.Exact<{
