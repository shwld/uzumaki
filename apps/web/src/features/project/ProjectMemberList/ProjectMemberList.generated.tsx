...
export type ProjectMemberList_ProjectMemberFragment = { __typename?: 'ProjectMember', id: string, role: Types.ProjectMemberRole, name: string, avatarImageUrl: string };
