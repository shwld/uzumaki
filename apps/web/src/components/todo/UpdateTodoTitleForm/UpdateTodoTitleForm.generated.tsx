...
export type UpdateTodoTitleFormFragment = {
  __typename?: 'Todo';
  id: string;
  title: string;
};
...
export type TodoUpdateTitleFormMutation = {
  __typename?: 'Mutation';
  updateTodoTitle:
    ...
    | {
        ...
        result: { __typename?: 'Todo'; id: string; title: string };
      };
};
...
export function useTodoUpdateTitleFormMutation() {
  return Urql.useMutation<
    TodoUpdateTitleFormMutation,
    TodoUpdateTitleFormMutationVariables
  >(TodoUpdateTitleFormDocument);
}
